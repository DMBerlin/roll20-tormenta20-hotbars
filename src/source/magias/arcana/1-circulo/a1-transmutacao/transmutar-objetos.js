module.exports = {
  ...
  "effects": [
    {
      ...
      "origin": "Compendium.tormenta20.magias.T1fJO9LOyBxtBBDN",
      "transfer": false,
      "tint": "#ffffff",
      "_stats": {
        "coreVersion": "13.342",
      ...
      "statuses": [],
      "sort": 0,
      "_key": "!items.effects!T1fJO9LOyBxtBBDN.rELA1ZjG7sVZikL8"
    },
    {
      "_id": "VL5A1KhUWApIJ2uv",
      "flags": {
        "tormenta20": {
          "onuse": true,
          "self": true,
      ...
      "name": "aumenta o limite de tamanho do objeto em uma categoria.",
      "img": "icons/svg/upgrade.svg",
      "type": "base",
      "system": {},
      "description": "",
      "statuses": [],
      "sort": 0,
      "_key": "!items.effects!T1fJO9LOyBxtBBDN.VL5A1KhUWApIJ2uv"
    },
    {
      "_id": "OgdJNSqMmFwzc3dx",
      "flags": {
        "tormenta20": {
          "onuse": true,
          "self": true,
      ...
      "name": "aumenta o preço máximo do objeto criado em um fator de x10 (+3 PM por T$ 250 de preço, +6 PM por T$ 2.500 de preço, e assim por diante).",
      "img": "icons/svg/upgrade.svg",
      "type": "base",
      "system": {},
      "description": "",
      "statuses": [],
      "sort": 0,
      "_key": "!items.effects!T1fJO9LOyBxtBBDN.OgdJNSqMmFwzc3dx"
    },
    {
      "_id": "UORlQJJN1mYl1x3P",
      "flags": {
        "tormenta20": {
          "onuse": true,
          "self": true,
      ...
      "name": "muda o alcance para toque, o alvo para 1 construto e a duração para instantânea. Em vez do normal, cura 2d8 PV do alvo. Você pode gastar 2 PM adicionais para aumentar a cura em +1d8.",
      "img": "icons/svg/upgrade.svg",
      "type": "base",
      "system": {},
      "description": "",
      "statuses": [],
      "sort": 0,
      "_key": "!items.effects!T1fJO9LOyBxtBBDN.UORlQJJN1mYl1x3P"
    },
    {
      "_id": "lDmZk5u7LoxzWW0S",
      "flags": {
        "tormenta20": {
          "onuse": true,
          "self": true,
      ...
      "statuses": [],
      "sort": 0,
      "_key": "!items.effects!T1fJO9LOyBxtBBDN.lDmZk5u7LoxzWW0S"
    },
    {
      "_id": "kOgRVcfCdYAyRlxR",
      "flags": {
        "tormenta20": {
          "onuse": true,
          "self": true,
      ...
      "name": "como o aprimoramento anterior, mas passa a afetar itens mágicos.",
      "img": "icons/svg/upgrade.svg",
      "type": "base",
      "system": {},
      "description": "",
      "statuses": [],
      "sort": 0,
      "_key": "!items.effects!T1fJO9LOyBxtBBDN.kOgRVcfCdYAyRlxR"
    },
    {
      "_id": "5yIIWf1kmySo4kXr",
      "changes": [
        {
          "key": "cura",
          "mode": 2,
      ...
      "statuses": [],
      "sort": 0,
      "_key": "!items.effects!T1fJO9LOyBxtBBDN.5yIIWf1kmySo4kXr"
    }
  ],
  ...
  "_stats": {
    ...
    "coreVersion": "13.342",
    "createdTime": 1664310461913,
    "modifiedTime": 1684622830660,
    "lastModifiedBy": "t20builder000000",
    "duplicateSource": null,
    "exportSource": null
  },
  "_key": "!items!T1fJO9LOyBxtBBDN"
};