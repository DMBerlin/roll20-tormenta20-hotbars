...
(function () {
    ...
    function filterSpells(searchTerm) {
        ...
        // Por enquanto, apenas atualiza o conteúdo da aba ativa
        // Esta função será expandida quando as magias forem implementadas
        updateTabContent(activeTab);
    }
