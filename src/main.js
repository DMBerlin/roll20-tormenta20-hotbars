...
(function () {
        ...
        function updateSkillList() {
            ...
            orderedSkills.forEach(skill => {
                ...
                btn.onmouseenter = () => {
                    ...
                    const skillData = skillsData[skill.nome];
    ...
    async function loadSpellsDirectly() {
        ...
        const spellsData = require('./modules/grimorio/generated-spells-data');
    ...
    // Dados completos das perícias baseados no arquivo MD
    function getSkillsList() {
        // Use generated skills data if available, otherwise fall back to hardcoded data
        try {
            return require('./modules/skills/generated-skills-data');
        } catch {
            console.warn('Generated skills data not available, using hardcoded data');
            return [];
        }
    }

    // Dados das Perícias do Tormenta 20
    const skillsData = getSkillsList();
...
${conditionData.efeitos || conditionData.descricao}}}`;
    ...
    function getConditionsList() {
        ...
        try {
            return require('./modules/conditions/generated-conditions-data');
        } catch {
