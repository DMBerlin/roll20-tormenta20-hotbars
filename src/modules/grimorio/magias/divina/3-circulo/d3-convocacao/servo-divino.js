  ...
  "effects": [
    {
      ...
      "origin": "Compendium.tormenta20.magias.iHW9iWhl7DYu3ggt",
      "transfer": false,
      "tint": "#ffffff",
      "_stats": {
        "coreVersion": "13.342",
      ...
      "name": "muda a duração para 1 dia ou até ser descarregada. O espírito realiza uma tarefa a sua escolha que exija até um dia. O custo do pagamento aumenta para T$ 500. O resto segue normal.",
      ...
      "statuses": [],
      "sort": 0,
      "_key": "!items.effects!iHW9iWhl7DYu3ggt.vqD2IOqb07ojo0el"
    },
    {
      "_id": "FQ43qgzKHiNWmojm",
      "flags": {
        "tormenta20": {
          "onuse": true,
          "pessoal": true,
      ...
      "changes": [
        {
          "key": "duração",
          "value": "1 semana ou até ser descarregada",
          "mode": 5,
          "priority": null
        }
      ],
      ...
      "name": "muda a duração para 1 semana ou até ser descarregada. O espírito realiza uma tarefa que exija até uma semana. O custo do pagamento aumenta para T$ 1.000. O resto segue normal.",
      "img": "icons/svg/upgrade.svg",
      "type": "base",
      "system": {},
      "description": "",
      "statuses": [],
      "sort": 0,
      "_key": "!items.effects!iHW9iWhl7DYu3ggt.FQ43qgzKHiNWmojm"
    }
  ],
