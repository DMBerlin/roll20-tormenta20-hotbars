module.exports = {
  ...
  "effects": [
    {
      ...
      "origin": "Compendium.tormenta20.magias.vvVVqYlYER6WpqhM",
      "transfer": false,
      "tint": "#ffffff",
      "_stats": {
        "coreVersion": "13.342",
      ...
      "name": "aumenta a quantidade do elemento em um passo (uma categoria de tamanho para água ou terra, +1 quadrado de 1,5m para ar e fogo).",
      ...
      "statuses": [],
      "sort": 0,
      "_key": "!items.effects!vvVVqYlYER6WpqhM.Hp8Z2nPlbYVhB8eU"
    },
    {
      "_id": "wK72592kCWxLLTLL",
      "flags": {
        "tormenta20": {
          "onuse": true,
          "pessoal": true,
      ...
      "statuses": [],
      "sort": 0,
      "_key": "!items.effects!vvVVqYlYER6WpqhM.wK72592kCWxLLTLL"
    },
    {
      "_id": "Mz8829iyEZ0ENP6T",
      "flags": {
        "tormenta20": {
          "onuse": true,
          "pessoal": true,
      ...
      "name": "se escolheu fogo, aumenta o dano inicial de cada chama em +1d6.",
      "img": "icons/svg/upgrade.svg",
      "type": "base",
      "system": {},
      "description": "",
      "statuses": [],
      "sort": 0,
      "_key": "!items.effects!vvVVqYlYER6WpqhM.Mz8829iyEZ0ENP6T"
    }
  ],
  ...
  "system": {
    ...
    "rolls": [
      {
        "name": "Dano (Objeto de água ou terra)",
        "key": "dano0",
        "type": "dano",
        "parts": [
          [
