module.exports = {
  ...
  "effects": [
    {
      ...
      "name": "muda o alcance para médio, a área para esfera com 3m de raio e o alvo para criaturas escolhidas.",
      ...
      "statuses": [],
      "sort": 0,
      "_key": "!items.effects!6KC8s8eUUKYCremp.ERjKGgKCirntEjat"
    },
    {
      "_id": "6z5H2TeCMMkrCv5I",
      "flags": {
        "tormenta20": {
          "onuse": true,
          "pessoal": true,
      ...
      "statuses": [],
      "sort": 0,
      "_key": "!items.effects!6KC8s8eUUKYCremp.6z5H2TeCMMkrCv5I"
    },
    {
      "_id": "bLE60ZwKrjQ5twTt",
      "flags": {
        "tormenta20": {
          "onuse": true,
          "pessoal": true,
      ...
      "statuses": [],
      "sort": 0,
      "_key": "!items.effects!6KC8s8eUUKYCremp.bLE60ZwKrjQ5twTt"
    },
    {
      "_id": "6FkFv2SbHkysYY5F",
      "flags": {
        "tormenta20": {
          "onuse": true,
          "pessoal": true,
      ...
      "name": "muda o alvo para área de cubo de 9m, a duração para permanente e adiciona componente material (chave de esmeralda no valor de T$ 2.000). Em vez do normal, nenhum tipo de movimento planar pode ser feito para entrar ou sair da área.",
      "img": "icons/svg/upgrade.svg",
      "type": "base",
      "system": {},
      "description": "",
      "statuses": [],
      "sort": 0,
      "_key": "!items.effects!6KC8s8eUUKYCremp.6FkFv2SbHkysYY5F"
    },
    {
      "_id": "IIW5Xg3KHd2tAwSB",
      "flags": {
        "tormenta20": {
          "onuse": true,
          "pessoal": true,
      ...
      "name": "muda o alcance para médio, a área para esfera de 3m de raio e o alvo para criaturas escolhidas. Cria um fio de energia (veja acima) que prende todos os alvos ao centro da área.",
      "img": "icons/svg/upgrade.svg",
      "type": "base",
      "system": {},
      "description": "",
      "statuses": [],
      "sort": 0,
      "_key": "!items.effects!6KC8s8eUUKYCremp.IIW5Xg3KHd2tAwSB"
    },
    {
      "_id": "9so5kjaDrhlh2nf8",
      "changes": [],
      "disabled": false,
      "duration": {
        "rounds": 1,
      ...
      "statuses": [],
      "sort": 0,
      "_key": "!items.effects!6KC8s8eUUKYCremp.9so5kjaDrhlh2nf8"
    }
  ],
  ...
  "_stats": {
    ...
    "coreVersion": "13.342",
    "createdTime": 1664310461762,
    "modifiedTime": 1684622830660,
    "lastModifiedBy": "t20builder000000",
    "duplicateSource": null,
    "exportSource": null
  },
  "_key": "!items!6KC8s8eUUKYCremp"
};