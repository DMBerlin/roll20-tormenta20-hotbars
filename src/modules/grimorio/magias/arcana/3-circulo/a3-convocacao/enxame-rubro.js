  ...
  "effects": [
    {
      ...
      "origin": "Compendium.tormenta20.magias.K2VH0rr4Qw6OqQjA",
      "transfer": false,
      "tint": "#ffffff",
      "_stats": {
        "coreVersion": "13.342",
      ...
      "name": "além do normal, uma criatura que falhe no teste de Reflexos fica agarrada (o enxame escala e cobre o corpo dela). A criatura pode gastar uma ação padrão e fazer um teste de Acrobacia ou Atletismo para escapar. Se você mover o enxame, a criatura fica livre.",
      ...
      "statuses": [],
      "sort": 0,
      "_key": "!items.effects!K2VH0rr4Qw6OqQjA.qjUdUNOHZMHUZn7l"
    },
    {
      "_id": "UFFFl7Mcw07E6mlZ",
      "flags": {
        "tormenta20": {
          "onuse": true,
          "pessoal": true,
      ...
      "statuses": [],
      "sort": 0,
      "_key": "!items.effects!K2VH0rr4Qw6OqQjA.UFFFl7Mcw07E6mlZ"
    },
    {
      "_id": "XFjoMck9YYIaBTna",
      "flags": {
        "tormenta20": {
          "onuse": true,
          "pessoal": true,
      ...
      "statuses": [],
      "sort": 0,
      "_key": "!items.effects!K2VH0rr4Qw6OqQjA.XFjoMck9YYIaBTna"
    },
    {
      "_id": "WqHRcdduicceDQE4",
      "flags": {
        "tormenta20": {
          "onuse": true,
          "pessoal": true,
      ...
      "name": "o enxame vira Enorme (quadrado de 6m de lado).",
      "img": "icons/svg/upgrade.svg",
      "type": "base",
      "system": {},
      "description": "",
      "statuses": [],
      "sort": 0,
      "_key": "!items.effects!K2VH0rr4Qw6OqQjA.WqHRcdduicceDQE4"
    },
    {
      "_id": "L5qKx8JhAMTpnzPG",
      "flags": {
        "tormenta20": {
          "onuse": true,
          "pessoal": true,
      ...
      "name": "o enxame ganha deslocamento de voo 18m e passa a ocupar um cubo ao invés de um quadrado.",
      "img": "icons/svg/upgrade.svg",
      "type": "base",
      "system": {},
      "description": "",
      "statuses": [],
      "sort": 0,
      "_key": "!items.effects!K2VH0rr4Qw6OqQjA.L5qKx8JhAMTpnzPG"
    },
    {
      "_id": "dsOs1Fs8OK7H6dVo",
      "flags": {
        "tormenta20": {
          "onuse": true,
          "pessoal": true,
      ...
      "statuses": [],
      "sort": 0,
      "_key": "!items.effects!K2VH0rr4Qw6OqQjA.dsOs1Fs8OK7H6dVo"
    }
  ],
  "folder": "q3HWop0SV641gJ2W",
  "sort": 0,
  "flags": {},
  "system": {
    "description": {
